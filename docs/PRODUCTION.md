...
| `myagent_llm_requests_total` | Counter | LLM API requests |
| `myagent_llm_latency_seconds` | Histogram | LLM response latency |
| `myagent_sessions_active` | Gauge | Active sessions |
| `myagent_tokens_used_total` | Counter | Total tokens used |
